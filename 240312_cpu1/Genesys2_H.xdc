...
## Buttons
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS12} [get_ports {KEY}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets KEY] 
#set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVCMOS12} [get_ports {}]
...
## LEDs·1
set_property -dict {PACKAGE_PIN T28 IOSTANDARD LVCMOS33} [get_ports {LEDR[0]}]
set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports {LEDR[1]}]
set_property -dict {PACKAGE_PIN U30 IOSTANDARD LVCMOS33} [get_ports {LEDR[2]}]
set_property -dict {PACKAGE_PIN U29 IOSTANDARD LVCMOS33} [get_ports {LEDR[3]}]
set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS33} [get_ports {LEDR[4]}]
set_property -dict {PACKAGE_PIN V26 IOSTANDARD LVCMOS33} [get_ports {LEDR[5]}]
set_property -dict {PACKAGE_PIN W24 IOSTANDARD LVCMOS33} [get_ports {LEDR[6]}]
set_property -dict {PACKAGE_PIN W23 IOSTANDARD LVCMOS33} [get_ports {LEDR[7]}]
